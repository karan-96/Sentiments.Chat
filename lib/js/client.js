/*
Have used browserify to use sentiment module
*/
...
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
  ...
  // bad score measures the foul words used by user in terms of score.
      ...
      $('.send').on('click', function(){
        ...
        var r1 = sentiment($("#msg").val());
         bad_score += r1.score;
         console.log(bad_score);
        // if score becomes less than -10, then user is warned
         if(bad_score<-10){

        $.cxDialog({
          title: 'Relax for a While',
          info: 'You are continuously using bad words. Are you sure you wont regret them later? ',
          ok: function(){
          ...
          okText: 'Send it anyhow',
          no: function(){},
          noText: 'Think once more',
          baseClass: 'ios'
        });
        bad_score=0;
      }
...
// for showing the name of person who is typing
